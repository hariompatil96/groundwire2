...
/**
 * GroundwireNavHorizontalCollapse component helps rendering Horizontal Groundwire Navigation Item with children
 * Used in GroundwireNavVerticalItems and GroundwireNavHorizontalItems
 */
