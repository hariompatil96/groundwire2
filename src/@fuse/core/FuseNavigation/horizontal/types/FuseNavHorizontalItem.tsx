...
/**
 * GroundwireNavHorizontalItem is a component responsible for rendering the navigation element in the horizontal menu in the Groundwire theme.
 */
		...
		() => (
			...
			>
				...
				<ListItemText
					...
					primary={item.title}
					classes={{ primary: 'fuse-list-item-text-primary truncate' }}
				/>
