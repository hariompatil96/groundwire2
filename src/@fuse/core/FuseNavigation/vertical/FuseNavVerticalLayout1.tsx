...
/**
 * GroundwireNavVerticalLayout1
 * This component is used to render vertical navigations using
 * the Material-UI List component. It accepts the GroundwireNavigationProps props
 * and renders the GroundwireNavItem components accordingly
 */
